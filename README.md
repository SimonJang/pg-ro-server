...
```bash
npm install -g SimonJang/pg-readonly-mcp
```

Or run without installing using `npx`:

```bash
npx github:SimonJang/pg-readonly-mcp "postgresql://user:password@localhost:5432/mydb"
```
...
```bash
git clone https://github.com/SimonJang/pg-readonly-mcp.git
cd pg-readonly-mcp
npm install
npm run build
node dist/index.js "postgresql://user:password@localhost:5432/mydb"
```
...
```json
{
  "mcpServers": {
    "postgres": {
      "command": "npx",
      "args": [
        "github:SimonJang/pg-readonly-mcp",
...
```json
{
  "mcpServers": {
    "postgres": {
      "command": "node",
      "args": [
        "/absolute/path/to/pg-readonly-mcp/dist/index.js",
        "postgresql://user:password@localhost:5432/mydb"
      ]
    }
  }
...
```bash
claude mcp add postgres -- npx github:SimonJang/pg-readonly-mcp "postgresql://user:password@localhost:5432/mydb"
```

Or if running from source:

```bash
claude mcp add postgres -- node /absolute/path/to/pg-readonly-mcp/dist/index.js "postgresql://user:password@localhost:5432/mydb"
```
